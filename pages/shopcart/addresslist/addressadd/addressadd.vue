<template>
	<view class="bigv">
		...
		<form @submit="formBindSubmit">
			...
			<view class="v2">
				<view class="v3">
					<text>所在地区</text><input name="x_address" type="text" placeholder="   选择 省/市/区"></input>
				</view>
				<view class="v3">
					<text>详细地址</text><input name="details_ads" type="text" placeholder="   道路、街道门牌、小区房号等"></input>
				</view>
			</view>
