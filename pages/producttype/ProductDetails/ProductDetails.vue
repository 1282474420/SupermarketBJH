...
<swiper class="tupian">
  <swiper-item><image class="tupian1" mode="widthFix" :src="GoodsInfo.picturepath"></image></swiper-item>
</swiper>
...
<view class="btm_tool">
  <navigator open-type="switchTab" url="../../home/home" class="tool_item">
     <view class="icon_png"><image class="icon_png" src="../../../static/images/dbimg/sy_01_03.png"></image></view>
     <view>首页</view>
  </navigator>
  <view class="tool_item">
    <view class="icon_png"><image class="icon_png" src="../../../static/images/img/kefu.png"></image></view>
    <view>客服</view>
    <button open-type="contact"></button>
  </view>
  <navigator open-type="switchTab" url="../../shopcart/cart/cart" class="tool_item">
    <view class="icon_png"><image class="icon_png" src="../../../static/images/dbimg/sy_03_03.png"></image></view>
    <view>购物车</view>
  </navigator>
