		...
		<view class="flex-item">
			<view class="info-box">
				...
				<view class="content-item2">
					<image src='http://139.129.97.88:8080/static/groupImg/share.png' style="width: 42rpx;height: 42rpx;">
				...
				<view class="eva-box">
					<view class="comment" @tap="toRatings">
						<view class="user-info uni-list-cell-navigate">
							<view class="face">
								<image src="http://139.129.97.88:8080/static/groupImg/nabi.jpg" class="imagess"></image>
							</view>
